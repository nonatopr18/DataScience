...
Demand = [] # é necessário gerar o vetor para iniciar os kpi, caso contrário dara erro
Error = []  # é necessário gerar o vetor para iniciar os kpi, caso contrário dara erro
